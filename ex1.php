    ...
    if(strlen($telefone) == 10 || strlen($telefone) == 11) {
        if(preg_match('/^[0-9]+$/', $telefone)) {
            ...
            if(in_array($ddd, ['11', '12', '13', '14', '15', '16', '17', '18', '19', '21', '22', '24', '27', '28', '31', '32', '33', '34', '35', '37', '38', '41', '42', '43', '44', '45', '46', '47', '48', '49', '51', '53', '54', '55', '61', '62', '63', '64', '65', '66', '67', '68', '69', '71', '73', '74', '75', '77', '79', '81', '82', '83', '84', '85', '86', '87', '88', '89', '91', '92', '93', '94', '95', '96', '97', '98', '99'])) {
                if(strlen($telefone) == 11 && substr($numero, 0, 1) == '9' && substr($numero, 1, 1) != '0') {
                  $resultado = '('.substr($telefone, 0, 2).') '.substr($telefone, 2, 5).'-'.substr($telefone, 7).'';
                } else if(strlen($telefone) == 10 && in_array(substr($numero, 0, 1), ['2', '3', '4', '5', '6', '7', '8'])) {
                  $resultado = '('.substr($telefone, 0, 2).') '.substr($telefone, 2, 4).'-'.substr($telefone, 6).'';
                } else {
...
<head>
    <meta charset="utf-8">
    <title>Validação e formatação de número de telefone</title>
</head>
<body>
  <p><?=$resultado?></p>
</body>
